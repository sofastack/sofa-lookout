...
public interface QueryStatement {
    ...
    QueryStatement setMatchers(List<Matcher> matchers);

    long startTime();

    long endTime();

    QueryStatement setStartTime(long startTime);

    QueryStatement setEndTime(long endTime);

    Map context();

    Collection<Series> executeQuery();
